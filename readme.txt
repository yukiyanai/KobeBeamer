...
# Yuki Yanai <yanai@lion.kobe-u.ac.jp>
# 04/18/2015
...
3. Once you put the KobeBeamer folder in the appropriate directory, type in the terminal:
    sudo mktexlsr
...
This color theme is distributed as [beamercolorthemeuribo.sty](beamercolorthemeuribo.sty).  It uses four officially defined school colors: Kobe-Brick (RGB: 196, 0, 0), Kobe-Green (23, 131, 46), Kobe-Blue (14, 47, 146), and Kobe-Gray (77,77, 77).
...
###########################################################
Since I am not allowed to distribute the official logos of Kobe University, the logo files are not available here.  You must either obtain the logos from the official website of the university or use nologo option (see Usage above).
